...
exports.putVideoData = async(name, description, txn_hash, nft_cid, video_cid, wallet_address, video_duration) => {
    return await conn.pool.query(query.INSERT_VIDEO_DATA, [name, description, txn_hash, nft_cid, video_cid, wallet_address, video_duration])
}